            ...
            <div className='w-full md:w-auto'>
              <form className='flex flex-col sm:flex-row gap-2'>
                <input
                  ...
                  className='px-5 py-3 rounded-lg bg-white/10 border border-white/20 text-white focus:outline-none focus:ring-2 focus:ring-[#edae49] min-w-[240px]  transition-all duration-300'
                  required
                />
                <button
                  type='submit'
                  className='bg-[#edae49] hover:bg-[#edae49]/90 text-white px-6 py-3 rounded-lg transform hover:scale-105 font-medium flex items-center justify-center transition-all duration-300'
                >
        ...
        <div className='grid grid-cols md:grid-cols-12 gap-8'>
          <div className='col-span-2 md:col-span-4'>
            ...
            <p className='text-gray-600 mb-6'>
              Elevating your tech expereience with premium products and
              execptional service.
            </p>
              ...
              {[
                ...
                return (
                  <a
                    href={platform.link}
                    key={platform.name}
                    className='group flex items-center justify-center w-9 h-9 rounded-full bg-gray-100 hover:bg-[#003d5b] transform hover:scale-110 transition'
                  >
                    <i
                      className={`bx bxl-${platform.name} group-hover:text-[#fff] text-xl transition-colors`}
                    ></i>
                  </a>
                );
              })}
                ...
                {['Visa', 'MasterCard', 'PayPal', 'Apple'].map((method) => {
                  return (
                    <div className='text-gray-400' key={method}>
                      <i
                        className={`bx bxl-${method.toLowerCase()} text-xl`}
                      ></i>
                    </div>
                  );
                })}
