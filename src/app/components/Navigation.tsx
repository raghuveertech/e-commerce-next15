        ...
        <div className='flex justify-between items-center'>
          <Link href='/' className='flex items-center'>
            <div className='flex items-center'>
              ...
              <span className='text-xl font-bold tracking-tight text-white'>
                Store
                <span className='text-[#edae49]'>Brand</span>
              </span>
            </div>
          </Link>
          <div className='hidden md:block flex-grow max-w-lg mx-8'>
            <form className='group relative'>
              ...
              <button
                type='submit'
                className='absolute right-1 top-1/2 -translate-y-1/2 text-white/70 p-1.5 hover:text-white rounded-full trasnsition-colors cursor-pointer'
              >
